...
export default function ResumePage() {
    return (
        <div className="h-screen w-full" id="container" onMouseMove={(event: React.MouseEvent) => trackCursor(event)}>
            ...
            <div className="mt-24 w-full text-center text-6xl font-semibold">
                Download Resume
            </div>
            ...
            <div className="my-8 flex justify-center w-full">
                ...
                <button onClick={() => window.location.href = "api/resume" } className="hover:bg-gray-900 rounded-lg border border-blue-300 px-4 py-1 text-3xl shadow-lg">
                    Download Resume
                </button>
                {/* </Link> */}
            </div>

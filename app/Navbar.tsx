        ...
        <>
            <div
                ...
                <div className="w-full px-3 h-12 text-sm flex justify-center">
                    ...
                    <div className="dark:bg-[#1b1b1baa] bg-white dark:text-inherit text-gray-900 dark:border dark:border-blue-300 rounded-xl inline-flex items-center md:justify-between justify-between py-3 md:py-6 px-3 dark:shadow-[1px_1px_5px_#1a1a1a] shadow-[1px_1px_10px_#000] md:gap-4 gap-1 dark:backdrop-blur-xl">

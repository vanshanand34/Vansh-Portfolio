...
export default function ResponsiveNavbar():
    JSX.Element {
    return (
        <div className="flex navbar justify-center py-4 font-sans font-semibold">
            <div className="md:max-w-[45vw] max-w-[70vw] sm:w-[40vw] md:w-[45vw] lg:w-[40vw]  border border-blue-300 rounded-xl md:h-[7vh] text-sm shadow-[1px_1px_5px_#1a1a1a] ">

                <div className="flex items-center md:justify-around justify-evenly h-full py-2 px-2">
                    <div className="bg-gray-600 py-1 px-2 rounded cursor-pointer hover:bg-gray-600 hover:bg-gray-800">
                        {/* home */}
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 256 256" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M216,120v96H152V152H104v64H40V120a8,8,0,0,1,2.34-5.66l80-80a8,8,0,0,1,11.32,0l80,80A8,8,0,0,1,216,120Z" opacity="0.2"></path><path d="M219.31,108.68l-80-80a16,16,0,0,0-22.62,0l-80,80A15.87,15.87,0,0,0,32,120v96a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V160h32v56a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V120A15.87,15.87,0,0,0,219.31,108.68ZM208,208H160V152a8,8,0,0,0-8-8H104a8,8,0,0,0-8,8v56H48V120l80-80,80,80Z"></path></svg>
                    </div>
                    <div className="flex items-center cursor-pointer hover:outline hover:outline-1 hover:outline-gray-600 rounded-lg p-1 hover:bg-gray-900">
                    ...
                    <div className="flex items-center cursor-pointer hover:outline hover:outline-1 hover:outline-gray-600 rounded-lg p-1 hover:bg-gray-900">
                        ...
                        <span className="hidden md:inline px-1">Contact Me</span>
                    </div>
                </div>
            </div>
        </div>

    ...
    const getNavStyling = (currNavItem: string): string => {
        return (
            activeElement == currNavItem ?
                ...
                "hover:bg-gray-800 hover:outline hover:outline-1 hover:outline-gray-600"
        )
    }
    ...
    return (
        <div className="flex navbar justify-center py-4 font-sans font-semibold">
            <div className="w-full px-3 md:h-[7vh] text-sm flex justify-center">
                ...
                <div className="border border-blue-300 rounded-xl inline-flex items-center md:justify-between justify-between h-full py-2 px-2 shadow-[1px_1px_5px_#1a1a1a] gap-4">
                    <Link href={"/"}>
